...
const TranscriptModel = require("../models/recievedTranscript");
const UserModel = require("../models/user");
const jwt = require("jsonwebtoken");

//Storage and retrival of recieved transcripts that are to be verified
...
const readAllTranscriptsForVerificationPage = async (req, res) => {
    try {
        // get all transcripts for a user
        let transcripts = await TranscriptModel.find().exec();
...
module.exports = {
    ...
    readAllTranscriptsForVerificationPage,
    create,
    setUploaded
}
