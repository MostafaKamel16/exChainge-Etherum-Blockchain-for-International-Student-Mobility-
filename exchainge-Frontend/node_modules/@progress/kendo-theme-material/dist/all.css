...
.k-panelbar > .k-item > .k-link.k-state-selected.k-state-hover.k-state-focused,
...
.k-panelbar > .k-panelbar-header > .k-link.k-state-selected.k-state-hover.k-state-focused {
...
.k-spreadsheet > .k-tabstrip-wrapper .k-tabstrip-items .k-item.k-state-active::after {
    border-color: white;
}
